...
public unsafe partial class RectGetEnclosingPointsBenchmarks : ManagedVsNativeBenchmarks<bool> {
    private readonly Point[] _managedPoints = [new(10, 10), new(90, 20), new(40, 80), new(5, 60)];
    private readonly NativePoint[] _nativePoints = [new(10, 10), new(90, 20), new(40, 80), new(5, 60)];
