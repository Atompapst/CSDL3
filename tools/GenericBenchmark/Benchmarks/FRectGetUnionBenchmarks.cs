...
/// <summary>
///     Managed CSDL_IMPL port (<see cref="FRect.TryUnion(FRect, FRect, out FRect)"/>,
///     CSDL/Video/rect/FRect.Extension.cs) vs the native SDL_GetRectUnionFloat it stands in for.
/// </summary>
[MediumRunJob]
[MemoryDiagnoser]
public unsafe partial class FRectGetUnionBenchmarks : ManagedVsNativeBenchmarks<bool> {
    private static readonly FRect B = new(50f, 50f, 100f, 100f);
    ...
    public void Setup() {
        ...
        FRect a = new(0f, 0f, 100f, 100f);
        FRect.Union(a, B, out FRect managed);
        NativeFRect na = new(a);
        NativeFRect nb = new(B);
    ...
    public override bool Managed() {
        FRect a = new(_counter++ & 15, 0f, 100f, 100f);
        return FRect.Union(a, B, out _);
    }

    [Benchmark]
    public override bool Native() {
        NativeFRect a = new(new FRect(_counter++ & 15, 0f, 100f, 100f));
        NativeFRect b = new(B);
