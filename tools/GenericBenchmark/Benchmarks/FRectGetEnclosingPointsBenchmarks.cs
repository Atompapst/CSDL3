...
public unsafe partial class FRectGetEnclosingPointsBenchmarks : ManagedVsNativeBenchmarks<bool> {
    private readonly FPoint[] _managedPoints = [new(10f, 10f), new(90f, 20f), new(40f, 80f), new(5f, 60f)];
    private readonly NativeFPoint[] _nativePoints = [new(10f, 10f), new(90f, 20f), new(40f, 80f), new(5f, 60f)];
