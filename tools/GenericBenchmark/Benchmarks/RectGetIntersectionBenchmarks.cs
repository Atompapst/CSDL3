...
[MediumRunJob]
[MemoryDiagnoser]
public unsafe partial class RectGetIntersectionBenchmarks : ManagedVsNativeBenchmarks<bool> {
    private static readonly Rect B = new(50, 50, 100, 100);
    ...
    public void Setup() {
        ...
        Rect.GetRectIntersection(in a, in B, out Rect managed);
        NativeRect na = new(a);
        NativeRect nb = new(B);
        GetRectIntersection(&na, &nb, out NativeRect native);
    ...
    public override bool Managed() {
        ...
        return Rect.GetRectIntersection(in a, in B, out _);
    }
    ...
    public override bool Native() {
        ...
        NativeRect b = new(B);
        return GetRectIntersection(&a, &b, out _) != 0;
    }
    ...
    [LibraryImport("SDL3", EntryPoint = "SDL_GetRectIntersection")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial byte GetRectIntersection(NativeRect* a, NativeRect* b, out NativeRect result);
}
